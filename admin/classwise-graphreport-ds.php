...
$attndstatus=$_POST['attendstats'];
   ...
   $_SESSION['claname']=$cname;
     $_SESSION['atdstatus']=$attndstatus;
            echo "<script>window.location.href='classwise-graph-report.php';</script>";
           }
        }
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-md-2 mt-30">Attendance  Status : </div>
<div class="col-md-6 mt-25">
<select class="form-control" name="attendstats" required="required">
