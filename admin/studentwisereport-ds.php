...
$todate=$_POST['tdate'];
   ...
   $_SESSION['claname']=$cname;
      $_SESSION['sname']=$stdname;
            echo "<script>window.location.href='studentwise-report.php';</script>";
           }
        }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Student Wise Count Report</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Studentwise Report Date slection</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Studentwise Attendance Report</h4>
                </div>
                <!-- /Title -->
...
<select class="form-control" name="className" id="className" onChange="getStudent(this.value);" required="required">
...
<div class="row">
<div class="col-md-2 mt-30">Student : </div>
<div class="col-md-6 mt-25">
<select class="form-control" name="studentname" id="studentname" o required="required">
<option value=""> Select </option>
