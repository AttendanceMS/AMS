...
$sql="INSERT INTO  tblclasses(className) VALUES(:clsname)";
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Add a Class</h4>
                </div>
                <!-- /Title -->
...
<input class="form-control" type="text" name="classname" placeholder="Class Name" required="true" autofocus>
</div>
</div>  
